...
public class FactoryA : AbsFactory {
  ...
  public Object Clone(ICloneable obj) {
    return obj.Clone();
  }
}

public class PontoConcretoA : Ponto, ICloneable {
  private int x, y;
  ...
  public Object Clone() {
    ...
    return fab.criaPont(this.x, this.y);
  }
}

public class CirculoConcretoA : Circulo, ICloneable {
  private int raio;
  private Ponto ponto;
  ...
  public Object Clone() {
    FactoryA fab = new FactoryA();
    return fab.criaCirc(this.raio, this.ponto.getX(), this.ponto.getY());
  }
}

public class RetanguloConcretoA : Retangulo, ICloneable {
  ...
  public Object Clone() {
    FactoryA fab = new FactoryA();
    return fab.criaRet(this.ponto1.getX(), this.ponto1.getY(), this.ponto2.getX(), this.ponto2.getY());
  }
}

public class TrianguloConcretoA : Triangulo, ICloneable {
  ...
  public Object Clone() {
    FactoryA fab = new FactoryA();
    return fab.criaTrian(this.ponto1.getX(), this.ponto1.getY(), this.ponto2.getX(), this.ponto2.getY(), this.ponto3.getX(), this.ponto3.getY());
  }
}
